            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav-pills align-content-end offset-8" style="color: white;">
                ...
                if (isset($_SESSION["usuario"])) {
                    echo "<li class='nav-item'>
                            <a class='btn btn-warning' href='views/checkout.php'>Carrito <span id='num_cart' class='badge bg-secondary'>$num_cart</span></a>
                        </li>";
                    echo "<li class='nav-item'>
                ...
                <?php
                    if (isset($_SESSION["usuario"])) {
                        echo '<li class="nav-item">';
                        echo '<a class="nav-link" style="color: white;" href="class/cerrarsesion.php">Cerrar sesión</a>';
                        echo '</li>';
                    } else {
                        echo '<li class="nav-item">';
