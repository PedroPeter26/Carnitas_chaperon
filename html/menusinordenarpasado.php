...
<body style="background-color: #EFE2CF;">
    ...
    <nav class="navbar navbar-expand-lg barranav">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav-pills align-content-end offset-8" style="color: white;">
                ...
                <li class="nav-item">
                <a class="nav-link" style="color: white;" href="#ubi" data-bs-toggle="modal" data-bs-target="#alta">Ubicación</a>
                </li>
                <li class="nav-item">
    ...
    <!--BARRA PARA ELEGIR PRODUCTOS-->
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid d-flex justify-content-evenly" style="top: 70px; width: 100%; background-color: #F9EFE1;">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#Carnitas">Carnitas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Tacos">Tacos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Lonches">Lonches</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Gringas">Gringas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Chicharrones">Chicharrones</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container contenido">
        ...
        <div class="row mb-5">
                    ...
                    <div class="row g-0 rounded" style="background-color: #FCF4E9; height: 150px;">
                        ...
                        <div class="col-7 col-md-8 col-lg-8">
                            <div class="card-body">
                                ...
                                <p class="card-text"><small class="text-body-secondary"><a href="" style="text-decoration: none; color: black;" data-bs-toggle="modal" data-bs-target="#modal1/2kg">Más información</a></small></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!--MODAL 1: 1/2 KG-->
            <div class="modal modals" tabindex="-1" id="modal1/2kg">
        ...
        <!--Cervezas-->
        <div class="row mb-5">
            <h2 class="mb-4" id="Bebidas">Bebidas</h2>
            <h3 class="mb-3">Cervezas</h3>
            <!--CARD 1: cervezas $30-->
            <div class="col-12 col-md-6 col-lg-6">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0 rounded" style="background-color: #FCF4E9; height: 150px;">
                        <div class="col-4 col-md-4 col-lg-4 d-flex justify-content-center align-items-center rounded-start"  style="background-color: white;">
        ...
        <div class="row mb-5">
            <h3 class="mb-3">Bebidas preparadas con alcohol</h3>
            <!--CARD 1: michelada-->
            <div class="col-12 col-md-6 col-lg-6">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0 rounded" style="background-color: #FCF4E9; height: 150px;">
        ...
        <!--Bebidas de sabor-->
        <div class="row mb-5">
            <h3 class="mb-3">Bebidas de sabor</h3>
            <!--CARD 1: refresco-->
            <div class="col-12 col-md-6 col-lg-6">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0 rounded" style="background-color: #FCF4E9; height: 150px;">
            ...
            <!--CARD 6: jugo del valle fruit-->
            <div class="col-12 col-md-6 col-lg-6">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0 rounded" style="background-color: #FCF4E9; height: 150px;">
                        <div class="col-4 col-md-4 col-lg-4 d-flex justify-content-center align-items-center rounded-start"  style="background-color: white;">
                            <img src="../img/jugobotella.jpg" class="img-fluid rounded-start" alt="orden de tacos" style="height: 120px; width: 180px;">
                        </div>
                        <div class="col-8 col-md-8 col-lg-8">
                            <div class="card-body">
        ...
        <div class="row mb-5">
            <h3 class="mb-3">Bebidas preparadas sin alcohol</h3>
