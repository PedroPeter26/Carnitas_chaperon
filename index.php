...
<body>
    ...
    if (isset($_SESSION["usuario"])) {
        ...
        // Consultar la base de datos para obtener el tipo de usuario
        $query = "SELECT tipo FROM USUARIOS WHERE user = :user";
        ...
        if ($resultado && isset($resultado['tipo']) && $resultado['tipo'] == 'admin') {
            header("Location: indexadmin.php");}else{
