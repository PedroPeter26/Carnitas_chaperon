...
<body>
    ...
    <?php if (isset($mesa)) : ?>
        ...
        <div class="content-wrapper p-5">
            ...
            <div class="container">
                <h1>Atendiendo mesa: <?php echo $mesa['numero_mesa']; ?></h1><br>
                <a href="comedor.php" class="btn btn-secondary">Regresar al comedor</i></a>
                <a class="btn btn-warning" href="checkout_comedor.php?mesa_id=<?php echo $mesa_id; ?>">Ver orden</a>
                <br><br>
                <p id="estado-mesa">Estado de la mesa: <b><?php echo $mesa['estado']; ?></b></p>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-grid gap-2 col-12 d-md-flex mx-auto align-items-end">
                                                <button class="btn btn-outline-primary" type="submit" data-bs-toggle="modal" data-bs-target="#prodAgregado" onclick="addProducto(<?php echo $producto['producto_id']; ?>, <?php echo $mesa_id; ?>)">Agregar</button>
                                            </div>
