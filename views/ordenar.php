            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav dropdown-menu position-static gap-1 p-2 rounded-3 ms-auto shadow w-220px">
                        ...
                        <li><a class="dropdown-item rounded-2" href="ordenar.php">Ordenar</a></li>
                        <hr class="dropdown-divider">
                    ...
                    <div class="col-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-outline-primary" type="button" data-bs-toggle="modal" data-bs-target="#prodAgregado" onclick="addProducto(<?php echo $producto['producto_id']; ?>)">Agregar al carrito</button>
                            </div>
                        </div>
                    </div>
                <?php } ?>
