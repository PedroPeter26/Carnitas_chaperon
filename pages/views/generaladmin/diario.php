                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <div class="small-box" style="background-color: #CCD1D1;">
                            <div class="inner">
                                ...
                                $sql = $pdo->prepare("CALL DINERO_DIARIO_ONLINE('$today', @TotalDiarioOnline);");
                                $sql->execute();
                    ...
                    <div class="col-4">
                        ...
                        <div class="small-box" style="background-color: #B2BABB;">
                            <div class="inner">
                                <?php
                                $sql = $pdo->prepare("CALL DINERO_DIARIO_COMEDOR('$today', @TotalDiarioComedor);");
                                $sql->execute();
                    ...
                    <div class="col-4">
                        ...
                        <div class="small-box" style="background-color: #99A3A4;">
                            <div class="inner">
                                ...
                                $sql = $pdo->prepare("CALL DINERO_DIARIO_PLLEVAR('$today', @TotalDiarioPllevar);");
                                $sql->execute();
