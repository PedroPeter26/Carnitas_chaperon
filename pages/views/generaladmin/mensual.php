...
<body>
    ...
    <div class="content-wrapper">
        ...
        <!--GRAFICA DE PASTEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEL-->
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Gráfica de porcentaje ventas por categoría (mensual)</h3>
                </div>
                <div class="card-body">
        ...
        <?php
            try {
                ...
                $sql = "SELECT T.nombre AS categoria, COUNT(DO.producto) AS total_ventas
                    ...
                    WHERE O.status='Finalizado' AND MONTH(O.fecha) = MONTH(CURRENT_DATE())-- Cambiar la fecha por la fecha deseada
                    GROUP BY T.nombre;";
                $stmt = $pdo->prepare($sql);
                $stmt->execute();
