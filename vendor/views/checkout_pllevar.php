...
$pagina_anterior = "productos_pllevar.php";
...
<body>
    ...
    <div class="content-wrapper p-5" style="background-color: white;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-1">
                <a href="<?php echo $pagina_anterior ?>"> <i class="right fas fa-angle-left" style="color: black; font-size:40px;"></i> </a>
                </div>
                <div class="col-11">
                    <h2 style="font-family: 'Bricolage Grotesque', sans-serif;">Orden</h2> <br>
                </div>
            </div>
